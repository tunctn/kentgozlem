...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		...
		className={cn(
			...
			"border border-input bg-transparent px-3 py-2 text-sm shadow-xs ring-offset-background",
...
>(({ className, children, position = "popper", ...props }, ref) => (
	<SelectPrimitive.Portal>
		<SelectPrimitive.Content
			ref={ref}
			className={cn(
				"relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md glass-looking text-popover-foreground shadow-md",
